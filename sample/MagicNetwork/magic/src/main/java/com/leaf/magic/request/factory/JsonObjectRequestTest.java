...
public class JsonObjectRequestTest extends Request {

    private Response.Listener<JSONObject> mResponse;

    public JsonObjectRequestTest(Method method, String url, String mRequestBody, Response.Listener<JSONObject> mResponse, Response.ErrorResponse<String> mErrorResponse) {
        this.method = method;
        this.url = url;
